...
description: "Chart Agent Step 3: Hallucination Check"
---
...
- **원본 문맥 (Source Context)**: {{ source_context }} (내부 뉴스/리포트 + 도구 출력값)
...
```json
{
  "hallucination_checklist": [
    ...
    {
      "claim": "2025년 예상 성장률 50%",
      "source": "불명",
      "risk": "높음",
      "note": "문맥 어디에서도 이 성장률 수치를 찾을 수 없음."
    }
  ],
  "is_safe": true  // 중대한 위험(High risk)이 발견되면 false로 설정
}
```
